...
/**@author xStabu Edited for Arkt.code */
public abstract class colored {
	 ...
	 */
	public static class SphereColorPass extends colored {
		/**
	 ...
	 */
	public static class NoiseColorPass extends colored {
		/**
	 ...
	 */
	public static class FlatColorPass extends colored {
		public float min = 0f, max = 1f;
		public Color out = Color.white;
