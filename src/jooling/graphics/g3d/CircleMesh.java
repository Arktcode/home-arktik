...
import jooling.graphics.*;

/**@author Author xStabu OmaloonMod Edited By Arkt.code */
public class CircleMesh extends PlanetMesh{
    ...
    public void preRender(PlanetParams params){
        JooShaders.planetTextureShader.planet = planet;
        JooShaders.planetTextureShader.lightDir
                .set(planet.solarSystem.position)
                .sub(planet.position)
                .rotate(Vec3.Y, planet.getRotation())
                .nor();
        JooShaders.planetTextureShader.ambientColor
                .set(planet.solarSystem.lightColor);
        //TODO: better disappearing
        JooShaders.planetTextureShader.alpha = params.planet == planet ? 1f - params.uiAlpha : 1f;
    }
    ...
    private static Shader shader(){
        return JooShaders.planetTextureShader;
    }
}