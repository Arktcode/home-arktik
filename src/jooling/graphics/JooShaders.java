...
import jooling.graphics.shaders.DepthAtmosphereShader;
import jooling.graphics.shaders.DepthShader;
...
public class JooShaders {
    ...
    public static @Nullable SurfaceShader oxigen;
    public static CacheLayer.ShaderLayer oxigenLayer;
    ...
    public static void load() {
        ...
        oxigen = new SurfaceShader("oxigen");
        oxigenLayer = new CacheLayer.ShaderLayer(oxigen);
        CacheLayer.add(oxigenLayer);
    ...
    public static final class SurfaceShader extends Shader {
        Texture noiseTex;
